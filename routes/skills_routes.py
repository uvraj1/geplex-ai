...
(`description`, `when_to_use`, `bgplx_extra`, `procedure`).
"""
...
def _apply_skill_md(skills_manager, name: str, md: str, owner) -> bool:
    ...
    try:
        ...
        return bool(skills_manager.update_skill(name, {
            ...
            "pitfalls": sk.pitfalls, "verification": sk.verification, "bgplx_extra": sk.bgplx_extra,
        }, owner=owner))
    except Exception as e:
