...
from src.auth_helpers import get_current_user, require_user, is_admin_request
...
def setup_memory_routes(memory_manager: MemoryManager, session_manager: SessionManager, memory_vector=None):
    ...
    def _owner(request: Request) -> Optional[str]:
        ...
        # None means an unrestricted single-user/admin view to the memory
        # store; authenticated non-admin users always retain their namespace.
        return None if is_admin_request(request, user) else user
