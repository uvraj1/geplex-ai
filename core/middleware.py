...
INTERNAL_TOOL_TOKEN = os.environ.get("GEPLEX_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-GepLex-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-GepLex-Internal-Token), or
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        if is_report:
            ...
            response.headers["Content-Security-Policy"] = (
                ...
                "media-src 'self' blob:; "
                "connect-src 'self' https://*.googleapis.com https://*.firebaseio.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com; "
