...
class SkillsManager:
    ...
    def add_skill(
        ...
        sk = Skill(
            ...
            bgplx_extra=(solution if solution and not procedure else ""),
        )
        self._write_skill(sk)
    ...
    def update_skill(self, skill_id: str, updates: Dict, owner: Optional[str] = None) -> bool:
        ...
        for path in self._iter_skill_files():
            ...
            if "solution" in updates and "bgplx_extra" not in updates and not sk.procedure:
                sk.bgplx_extra = updates["solution"]
