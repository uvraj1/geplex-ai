...
- [ ] I searched [open issues](https://github.com/geplex-dev/geplex/issues) and [open PRs](https://github.com/geplex-dev/geplex/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses GepLex's existing visual language. Specifically:
