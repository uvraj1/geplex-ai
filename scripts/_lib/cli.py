"""scripts/_lib/cli.py — shared scaffolding for the `geplex-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("geplex-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/geplex-foo`
...
VERSION = "0.1.0"  # bumped centrally; every geplex-* CLI reports this
