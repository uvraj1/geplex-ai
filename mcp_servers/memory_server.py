...
Imports MemoryManager and MemoryVectorStore from the GepLex codebase.
"""
...
_OWNER_ENV_KEYS = ("GEPLEX_MCP_MEMORY_OWNER", "GEPLEX_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set GEPLEX_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
