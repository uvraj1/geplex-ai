...
COPILOT_USER_AGENT = os.environ.get(
    "GEPLEX_COPILOT_USER_AGENT", "GepLex/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "GEPLEX_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "GEPLEX_COPILOT_EDITOR_VERSION", "GepLex/1.0"
)
