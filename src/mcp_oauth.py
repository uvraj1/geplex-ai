...
Registration, authorization-code + PKCE, token refresh) to GepLex's web
...
# port GepLex binds — reverse proxy, public domain, or Docker, whose host port
# map is invisible inside the container — must set OAUTH_REDIRECT_BASE_URL (or
# APP_PUBLIC_URL), otherwise the redirect never lands back on GepLex.
