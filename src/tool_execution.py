...
_EMAIL_MCP_OWNER_ARG = "_geplex_owner"
...
async def _execute_tool_block_impl(
    ...
    from src.tool_implementations import (
        ...
        do_edit_image, do_generate_video, do_trigger_research, do_manage_research, do_resolve_contact,
        do_manage_contact,
    ...
    if tool in _MCP_TOOL_MAP:
        ...
        desc = "generate_video"
        result = await do_generate_video(content, session_id=session_id, owner=owner)
    elif tool == "edit_file":
