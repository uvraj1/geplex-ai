...
means the caller is authenticated by either a cookie session or a Bearer `gplx_`
...
<body><div class="card">
  ...
  <p class="warn">Shown once. This grants chat access to your GepLex; revoke it
