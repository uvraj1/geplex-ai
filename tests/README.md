...
```text
[order-report] working directory: /path/to/geplex
...
[order-report] reproduce with: /path/to/geplex/venv/bin/python /path/to/geplex/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
