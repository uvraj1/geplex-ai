"""`geplex-research list --status complete` was returning nothing.
...
Part of #2122 (geplex-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "geplex-research"
    loader = importlib.machinery.SourceFileLoader("geplex_research_cli", str(path))
