"""cmd_add (scripts/geplex-memory) must tolerate a non-dict row in the
...
def _load_cli(monkeypatch):
    ...
    path = ROOT / "scripts" / "geplex-memory"
    loader = importlib.machinery.SourceFileLoader("geplex_memory_cli_add", str(path))
