...
> **Scope:** This document describes the architecture of the GepLex no-build
...
| **`workspace.js`** | Workspace selection and project controls: safe file listing/editing, live preview, and source download alongside shell/file tool confinement. |
