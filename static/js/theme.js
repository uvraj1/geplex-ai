...
const LS_KEY = 'geplex-theme';
const CUSTOM_THEMES_KEY = 'geplex-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'GepLex Logo',    group: 'Sidebar' },
...
const UI_SCALE_KEY = 'geplex-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'geplex_' + (obj.name || 'theme') + '.json';
      a.click();
