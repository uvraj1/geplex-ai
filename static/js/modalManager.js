...
const _rememberedDockKey = (id) => `geplex-modal-remembered-dock-${id}`;
...
const _DOCK_STORAGE_KEY = 'geplex.mobileDockState.v1';
...
// Close any open bgplx-mounted popups (kebab dropdowns, split-button menus,
