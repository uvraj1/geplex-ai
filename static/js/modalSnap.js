...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'geplex-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'geplex-edge-dock-width';
...
function _onDockedModalGone(modal, dockClass) {
  ...
  // Clear bgplx-level dock state only for the side this modal owned, and only
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('geplex:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
