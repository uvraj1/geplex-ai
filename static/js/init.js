// GepLex UI — Initialization Scripts
...
function markComposerUserEdited() {
  ...
  msgInput.addEventListener('input', () => {
    window.__geplexComposerUserEdited = !!msgInput.value;
  });
}
...
function clearFreshComposerRestore() {
  ...
  if (window.__geplexComposerUserEdited || document.activeElement === msgInput) return;
  if (msgInput.value) {
    msgInput.value = '';
